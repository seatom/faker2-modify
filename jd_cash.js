...
const inviteCodes = [
`eU9Ya-q7M6138TyDwiUWhA@YE5mKLPvPKg@fVJ1Ka73`,
]
if ($.isNode()) {
...
!(async () => {
  ...
  await requireConfig()
  $.authorCode = await getAuthorShareCode('https://raw.githubusercontent.com/seatom/updateTeam/main/shareCodes/JD_Cash.json')
  if (!$.authorCode) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/seatom/updateTeam@main/shareCodes/JD_Cash.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    $.authorCode = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/seatom/updateTeam@main/shareCodes/JD_Cash.json') || []
  }
